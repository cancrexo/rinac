...
final class Frontend
{
    ...
    public function show_visitas_booking_form()
    {
        ...
        echo \Rinac\Template\TemplateHelper::get_template('forms/booking-form.php', $template_data);
    }
    ...
    public function render_quick_booking_modal($product_id = null)
    {
        ...
        return \Rinac\Template\TemplateHelper::get_template('modals/quick-booking-modal.php', $template_data);
    }
    ...
    public function render_booking_details_modal($booking_data)
    {
        ...
        return \Rinac\Template\TemplateHelper::get_template('modals/reserva-details-modal.php', $template_data);
    }
